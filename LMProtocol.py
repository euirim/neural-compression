...
class LMProtocol:
	...
	def __init__(self, language_model, context_window_length=16, next_word_possibilities_number=16, out_of_vocabulary_word_max_bit_size=1024, initial_context_max_bit_size=16384):
		"""
